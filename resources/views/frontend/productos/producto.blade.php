            ...
            <div class="row g-5 align-items-start">
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <div class="producto-img-box">
                        ...
                        <img src="{{ asset($producto->imagenes->first()->ruta ?? 'images/default-product.png') }}"
